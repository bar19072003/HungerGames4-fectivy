...
class UserController {
     ...
     */
    createUser(req, res) {
        const { username, password, name, phone, address, role, picture, coordinates } = req.body;
        ...
        try {
            ...
            const newUser = userService.createUser({ username, password, name, phone, address, role, picture, coordinates });
